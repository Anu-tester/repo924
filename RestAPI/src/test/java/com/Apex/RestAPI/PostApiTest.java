...
public class PostApiTest extends BaseClass {
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
		...
		Users users = new Users("Testing", "QA"); //expected users obejct
		
		//object to json file:
		mapper.writeValue(new File("C:\\Users\\Anu\\Ecommercenew"
				+ "\\RestAPI\\src\\main\\java\\com\\Apex\\RestAPI\\users.json"), users);
		//https://reqres.in/api/users
